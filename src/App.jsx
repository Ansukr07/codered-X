  ...
  return (
    <div className="app-container" onMouseMove={handleMouseMove}>
      ...
      {trail.map((point, index) => (
        <div
          key={point.id}
          className="cursor-trail-highlight"
          style={{
